...
public class AttendanceService {
    ...
    public Map<String, Object> getAttendanceSummary(Long studentId, Long subjectId) {
        long total = attendanceRepo.countByStudentIdAndSubjectIdAndStatus(studentId, subjectId,
                ...
                + attendanceRepo.countByStudentIdAndSubjectIdAndStatus(studentId, subjectId, AttendanceStatus.ABSENT)
                + attendanceRepo.countByStudentIdAndSubjectIdAndStatus(studentId, subjectId, AttendanceStatus.LATE);
        long present = attendanceRepo.countByStudentIdAndSubjectIdAndStatus(studentId, subjectId,
                AttendanceStatus.PRESENT);
        long late = attendanceRepo.countByStudentIdAndSubjectIdAndStatus(studentId, subjectId, AttendanceStatus.LATE);
